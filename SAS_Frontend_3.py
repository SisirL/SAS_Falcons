...
class App:
    ...
    def login(self, approved:bool=False) -> bool:
        ...
        self.lbl_email = ttk.Label(self.frm_login, text='Email:')
        self.ent_email = ttk.Entry(self.frm_login)
        self.ent_email.focus_set()
        self.lbl_pwd = ttk.Label(self.frm_login, text='Password:')
        self.ent_pwd = ttk.Entry(self.frm_login, show='*')
        self.btn_proceed = ttk.Button(self.frm_login, text='Proceed', command=self.approve_login)
        self.lbl_email.grid(row=1, column=1, sticky='w')
        self.ent_email.grid(row=1, column=2)
        self.lbl_pwd.grid(row=2, column=1, sticky='w')
        self.ent_pwd.grid(row=2, column=2)
